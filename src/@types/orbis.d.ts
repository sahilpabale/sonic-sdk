...
//     only_master?: boolean;
//     tag?: string;
//     algorithm?: GetPostsAlgorithm;
//   }

//   type GetPostsAlgorithma = 'recommendations' | 'all-posts' | 'all-posts-non-filtered';
...
declare module '@orbisclub/orbis-sdk' {
  export class Orbis {
    ...
    getPosts(options: GetPostsOptions, page?: number = 0): Promise<GetPostsResponse>;
    ...
    getReaction(post_id: string, did: string): Promise;
  }
  ...
  export interface IOrbis {
    ...
    createContext: () => void;
    createConversation: (content: { recipients: string[]; name?: string; description?: string; context?: string }) => Promise<{
      status: number;
      doc: string;
      result: string;
    }>;
    createGroup: (content: { name: string; pfp?: string; description?: string }) => Promise<{
      status: number;
      doc: string;
      result: string;
    }>;
    ...
    decryptMessage: (content: { conversation_id: string; encryptedMessage: IOrbisEncryptedBody }) => Promise<any>;
    ...
    getConversations: (did: string, context?: string) => Promise<any>;
  ...
  export interface IOrbisPost {
    ...
    master?: string | null;
    reply_to?: string | null;
    reply_to_creator_details?: Pick<IOrbisProfile['details'], 'did' | 'metadata' | 'profile'>;
